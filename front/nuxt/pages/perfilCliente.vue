        ...
        <div class="relative">
                        ...
                        <div class="w-full"><label
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center"><svg
                                        ...
                                        <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path>
                                        <circle cx="12" cy="7" r="4"></circle>
                                    </svg></div><input type="text" name="apellidos" v-model="formDataClient.apellidos"
                                    class="pl-10 w-full h-12 rounded-lg border border-gray-300 shadow-sm text-sm">
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="w-full"><label class="block text-md font-medium text-gray-700 mb-1">Correu</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="w-full"><label class="block text-md font-medium text-gray-700 mb-1">Telèfon</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-phone h-5 w-5 text-gray-400">
                                        <path
            ...
            <div v-else-if="currentSection === 'address'" class="mx-3">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="w-full"><label class="block text-md font-medium text-gray-700 mb-1">Ciutat</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-building h-5 w-5 text-gray-400">
                        ...
                        <div class="w-full"><label
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center"><svg
                                        ...
                                        <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
                                        <circle cx="12" cy="10" r="3"></circle>
                                    </svg></div><input type="text" name="provincia" v-model="formDataStreet.provincia"
                                    class="pl-10 w-full h-12 rounded-lg border border-gray-300 shadow-sm text-sm">
                            </div>
                        </div>
                    </div>
