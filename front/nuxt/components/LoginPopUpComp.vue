            ...
            <form @submit.prevent="login" class="space-y-6">
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700">Correu
                        ...
                        Usuari</label>
                    <div class="mt-1">
                        <input id="email" v-model="formData.email" type="text" data-testid="username" required=""
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    ...
                    <button
                        ...
                        <svg class="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="800px"
                            height="800px" viewBox="2 2 28 28" version="1.1">
                            <path
