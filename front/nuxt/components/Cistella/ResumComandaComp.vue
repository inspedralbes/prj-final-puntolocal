<template>
    <div id="allOrder" class="rounded-md bg-white p-2">
        ...
        <div class="my-3 max-h-[250px] overflow-scroll">
            <div v-for="(items) in productosComercios">
                <div v-for="item in items" :key="item.id" class="flex mb-1">
                    <div id="contain-image" class="mr-2 w-[70px] h-[70px] overflow-hidden">
        ...
        <div id="allTotal" class="mt-3">
            <div class="w-full flex flex-col">
                <div class="w-full flex justify-between">
                    ...
                    <h3 class="text-base text-gray-500">{{ totalPrice.toFixed(2) }} €</h3>
                </div>
                <div class="w-full flex justify-between">
            ...
            <div class="border-t border-gray-300 mt-3 flex justify-between w-full">
                ...
                <h3 class="font-medium text-xl">{{ totalPrice.toFixed(2) }} €</h3>
            </div>
        </div>
    </div>
</template>
