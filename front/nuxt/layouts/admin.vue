                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <h2
                            ...
                            Panel de comerç</h2>
                        <form id="buscador" action="#" method="GET" class="hidden lg:block lg:pl-3.5">
                            <label for="topbar-search" class="sr-only">Buscar...</label>
                            <div class="relative mt-1 lg:w-96">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg id="lupita" class="w-5 h-5 text-gray-500 dark:text-gray-400"
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center ml-2">
                            <div id="profile">
                                <button type="button"
                                    class="toggle-button-settings flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                            ...
                            <div v-if="isOpen['settings']"
                                ...
                                id="dropdown-2"
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1713px, 61px);"
                                data-popper-placement="bottom">
            ...
            <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                <div
                    ...
                    <ul class="pb-2 space-y-2">
                        <li>
                            <form id="buscadorMobile" action="#" method="GET" class="lg:hidden">
                            ...
                            <ul id="dropdown-layouts" :class="{ hidden: isHidden['productes'] }" class="py-2 space-y-2">
                                <li>
                                    <a href="https://flowbite-admin-dashboard.vercel.app/layouts/stacked/"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Afegir
                                        producte</a>
                                </li>
                                <li>
                                    <a href="https://flowbite-admin-dashboard.vercel.app/layouts/sidebar/"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Inventaris</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                    sidebar-toggle-item="">Configuración</span>
...
const handleClickOutside = (event) => {
    // Cerrar todos los menús si el clic no es en ninguno de ellos
    if (event.target.closest('.toggle-button-settings') || event.target.closest('.dropdown-settings')) {
        isOpen['settings'] = true;
        isOpen['notifications'] = false;
    } else if (event.target.closest('.toggle-button-notifications') || event.target.closest('.dropdown-notifications')) {
        isOpen['settings'] = false;
        isOpen['notifications'] = true;
    } else {
        isOpen['settings'] = false;
        isOpen['notifications'] = false;
    }
